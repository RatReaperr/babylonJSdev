...
function createCapsule2(scene: Scene) {
  let capsule = MeshBuilder.CreateCapsule(
    "capsule",
    { radius: 0.2, height: .7, },
    scene
...
function createCapsule3(scene: Scene) {
  let capsule = MeshBuilder.CreateCapsule(
    "capsule",
    { radius: 0.2, height: .7, },
    scene
...
function createCapsule4(scene: Scene) {
  let capsule = MeshBuilder.CreateCapsule(
    "capsule",
    { radius: 0.2, height: .7, },
    scene
...
function createCapsule5(scene: Scene) {
  let capsule = MeshBuilder.CreateCapsule(
    "capsule",
    { radius: 0.2, height: .7, },
    scene
...
function createCapsule6(scene: Scene) {
  let capsule = MeshBuilder.CreateCapsule(
    "capsule",
    { radius: 0.2, height: .7, },
    scene
...
function createHemisphericLight(scene: Scene) {
  const light = new HemisphericLight(
    "light",
    new Vector3(4, 1, 0), // move x pos to direct shadows
    scene
  );
  light.intensity = 0.7;
...
export default function createStartScene(engine: Engine) {
  ...
  let capsule2 = createCapsule2(scene);
  let capsule3 = createCapsule3(scene);
  let capsule4 = createCapsule4(scene);
  let capsule5 = createCapsule5(scene);
  let capsule6 = createCapsule6(scene);
